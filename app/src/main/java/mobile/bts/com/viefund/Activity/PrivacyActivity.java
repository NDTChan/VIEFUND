...
public class PrivacyActivity extends CustomColor {

    private Toolbar toolbar;
    public static final String url = UrlModel.url_setting;
    public static String TAG = PrivacyActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tw.setText(R.string.setting_privacy);
    ...
    private void setUpWebView(){
        final WebView webView = findViewById(R.id.wvContentPrivacy);
        webView.setWebViewClient(new MyWebViewClient(PrivacyURL));
        String url = PrivacyURL.trim();
