...
public class DisclosureActivity extends CustomColor {

    private Toolbar toolbar;
    public static final String url = UrlModel.url_setting;
    public static String TAG = DisclosureActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disclosure_activity);
        toolbar = findViewById(R.id.toolbarDisclosure);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayShowTitleEnabled(false);
        TextView tw =toolbar.findViewById(R.id.app_bar_title);
        tw.setText(R.string.setting_disclosure);
    ...
    private void setUpWebView(){
        final WebView webView = findViewById(R.id.wvContentDisclosure);
        webView.setWebViewClient(new MyWebViewClient(DisclosureURL));
        String url = DisclosureURL.trim();
