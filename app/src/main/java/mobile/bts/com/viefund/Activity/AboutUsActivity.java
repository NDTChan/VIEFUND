...
public class AboutUsActivity extends CustomColor {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tw.setText(getString(R.string.nav_about_us) + "");
    ...
    private void setUpWebView(){
        final WebView webView = findViewById(R.id.wvContentAboutUs);
        webView.setWebViewClient(new MyWebViewClient(AboutURL));
        String url = AboutURL.trim();
