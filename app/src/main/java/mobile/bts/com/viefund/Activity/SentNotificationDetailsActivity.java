...
public class SentNotificationDetailsActivity extends CustomColor {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sent_notification_details);
                ...
                try {
                    ...
                    if (result == 0) {
                        ...
                        if(lstNotification.length()>0){
                            ...
                            data.setFrom(objJson.getString("To"));
                        ...
                        _twFomeNoticeInfo.setText(getString(R.string.la_mess_from)+": Me");
                        _twToNoticeinfo.setText(getString(R.string.la_mess_to)+": "+data.getFrom());
