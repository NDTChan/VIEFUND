...
public class TermsOfUseActivity extends CustomColor {

    private Toolbar toolbar;
    public static final String url = UrlModel.url_setting;
    public static String TAG = TermsOfUseActivity.class.getSimpleName();
    ...
    private void setUpWebView(){
        final WebView webView = findViewById(R.id.wvContentTermsOfUse);
        webView.setWebViewClient(new MyWebViewClient(TermsOfUseURL));
        String url = TermsOfUseURL.trim();
