 ...
 */
public class FundPerformanceFragment extends CustomColorFrag {
    public static final String TAG = FundPerformanceFragment.class.getSimpleName();
    ...
    private Dao<AccountFundPerformance, String> _AccountFundPerformanceDao = null; // param dao for connet entities PlanAccount
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_account_fund_perform, container, false);
        ...
        try {
            _AccountFundPerformanceDao = mDB.getAccountFundPerformanceDao();
        } catch (SQLException e) {
            e.printStackTrace();
        }
        mTableLayout = (TableLayout) v.findViewById(R.id.fragTableAccountPerform);
        mTableLayout.removeAllViews();
        SynchroData();
        return v;
    }

    public void LoadTableLayout(List<AccountFundPerformance> obj) {
        ArrayList<AccountFundPerformance> data = new ArrayList<>();
        data.addAll(obj);
        int rows = obj.size();
        int leftRowMargin = 1;
        int topRowMargin = 1;
...
//        final TextView tvFirst = new TextView(getContext());
//        tvFirst.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
//        tvFirst.setGravity(Gravity.CENTER);
//        tvFirst.setPadding(5, 15, 5, 15);
//        tvFirst.setBackgroundColor(Color.parseColor("#f8f8f8"));
//        tvFirst.setText("Compound Return as of October 11, 2018");
//
//        final LinearLayout layCustomerFirst = new LinearLayout(getContext());
//        layCustomerFirst.setOrientation(LinearLayout.HORIZONTAL);
//        layCustomerFirst.setPadding(0, 10, 0, 10);
//        layCustomerFirst.setBackgroundColor(Color.parseColor("#f8f8f8"));
//        LinearLayout.LayoutParams layParamsFirst = new TableRow.LayoutParams(TableRow.LayoutParams.MATCH_PARENT, TableRow.LayoutParams.MATCH_PARENT, 5);
//        layParamsFirst.setMargins(leftRowMargin, topRowMargin, rightRowMargin, bottomRowMargin);
//        layCustomerFirst.setLayoutParams(layParamsFirst);
//        layCustomerFirst.addView(tvFirst);
//
...
//        trParamsFirst.setMargins(leftRowMargin, topRowMargin, rightRowMargin, bottomRowMargin);
////        tr.setWeightSum(10);
//        tr.setPadding(0, 0, 0, 0);
//        tr.setLayoutParams(trParamsFirst);
//        tr.addView(layCustomerFirst);
//        idTable++;
//        //add vao table lay out
//        mTableLayout.addView(tr, trParamsFirst);
//        idTable++;
        ...
        for (int i = 0; i < rows; i++) {
            AccountFundPerformance row = obj.get(i);
...
//            layParams4.setMargins(leftRowMargin, topRowMargin, rightRowMargin, bottomRowMargin);
            ...
            // add table row
            final TableRow tra = new TableRow(getContext());
            tra.setId(idTable);
...
//            trParams.setMargins(leftRowMargin, topRowMargin, rightRowMargin, bottomRowMargin);
            tra.setWeightSum(10);
            tra.setPadding(0, 0, 0, 0);
            tra.setLayoutParams(trParams);
            tra.addView(layCustomer);
            tra.addView(layCustomer4);
            idTable++;
            //add vao table lay out
            mTableLayout.addView(tra, trParams);
            idTable++;
        }
    }
    ...
    public void SynchroData() {
        ...
        mDB.open();
        mDB.Delete_AccountFundPerformance_All();
        mDB.close();
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    Plan obj = new Plan();
                    List<AccountFundPerformance> obj2 = new ArrayList<AccountFundPerformance>();
                    ...
                    if (result == 0) {
                        ...
                        JSONObject objFundPerformance = new JSONObject(objAccountDetail.getString("FundPerformance"));
                        JSONArray arrayList = objFundPerformance.getJSONArray("List");
                        String planID = "";
                        if (arrayList.length() > 0) {
                            for (int i = 0; i < arrayList.length(); i++) {
                                    JSONObject objTemp = arrayList.getJSONObject(i);
                                    AccountFundPerformance objEntities = new AccountFundPerformance();
                                    ...
                                    _AccountFundPerformanceDao.create(objEntities);
                            }
                        }

                        obj2 = AccountFundPerformance.Load_AccountFundPerformance_By_AccountID(_AccountFundPerformanceDao, AccountID);
